<x-app-layout>
  ...
  <div class="flex justify-center bg-gray-100 mb-5">
    <div class="w-full max-w-5xl bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8 relative">
      ...
      <form class="flex flex-col " action="{{ route('categories.update', $category->id) }}" method="POST">
        @csrf 
        @method('POST')
        ...
        <div class="w-full flex flex-col md:flex-row gap-6">
          <div class="w-full md:w-1/2">
            ...
            <div class="mb-1">
              ...
              <textarea id="description" name="description" maxlength="255" rows="6" oninput="actualizarContador()"
                class="w-full p-3 bg-gray-100 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
