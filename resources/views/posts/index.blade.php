<x-app-layout>
  ...
  <div class="max-w-7xl mx-auto mb-5">
      ...
      <a href="{{ route('posts.create') }}">
         <div class="flex flex-col justify-center items-center rounded-2xl border-2 border-dashed border-gray-300 bg-white text-gray-400 hover:border-blue-500 hover:text-blue-500 transition-all duration-300 shadow-sm hover:shadow-lg p-6 cursor-pointer min-h-[370px] min-w-[320px]">
