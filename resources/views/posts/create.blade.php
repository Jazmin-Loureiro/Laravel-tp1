            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex-grow">
                    <div class="mb-5">
                        ...
                        <input type="text" id="title" name="title" maxlength="50" value="{{ old('title') }}"
                        ...
                        <small id="contador-title" class="block mt-1 text-xs text-gray-500">
                            {{ 50 - strlen(old('title')) }} caracteres restantes
                        </small>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="content" name="content" rows="9" maxlength="1500"
                            class="resize-y w-full bg-gray-100 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 break-words whitespace-pre-line"
                            placeholder="Contenido" required oninput="actualizarContador('content', 'contador-content', 1500)">{{ old('content') }}</textarea>
                        <small id="contador-content" class="block mt-1 text-xs text-gray-500">
                            {{ 1500 - strlen(old('content', '')) }} caracteres restantes
                        </small>
                    </div>
