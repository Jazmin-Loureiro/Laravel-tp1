<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden w-full flex flex-col justify-between p-6 mb-5">
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start">
            <div x-data="{ showModal: false }" 
                 class="w-full md:w-1/3 h-[250px] md:h-[400px] rounded-lg overflow-hidden shadow-md relative group">
                <img src="{{ asset('storage/' . $post->poster) }}"  
                     alt="Imagen del post {{ $post->title }}" 
                     class="w-full h-full object-cover object-center rounded-xl cursor-pointer"  
